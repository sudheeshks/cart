				...
				<div class='col-md-4'>
							<div class='panel panel-info'>
								...
								<div class='panel-body'>
									<img src='product_images/$pro_image' style='width:160px; height:130px;'/>
								</div>
					...
					echo '
						...
						';
							...
							echo   
								...
								'<button type="button" class="pull-right btn btn-primary" onclick="alert(\'Thank you for purchase.\')">Checkout</button>
								</form>';
				}
			}
	}
